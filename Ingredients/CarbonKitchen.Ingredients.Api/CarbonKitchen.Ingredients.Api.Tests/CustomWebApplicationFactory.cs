...
namespace CarbonKitchen.Ingredients.Api.Tests
{
    ...
    public class CustomWebApplicationFactory<TStartup> : WebApplicationFactory<TStartup> where TStartup : class
    {
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            ...
            {
                // Remove the app's IngredientDbContext registration.
                var descriptor = services.SingleOrDefault(
                    d => d.ServiceType ==
                        typeof(DbContextOptions<IngredientDbContext>));
                ...
                // Add IngredientDbContext using an in-memory database for testing.
                ...
                // context (IngredientDbContext).
                using (var scope = sp.CreateScope())
                {
                    var scopedServices = scope.ServiceProvider;
                    var db = scopedServices.GetRequiredService<IngredientDbContext>();
